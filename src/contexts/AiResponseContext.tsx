...
// -----------------------------
type GlobalState = typeof defaultState;
...
// -----------------------------
type Action =
  | { type: "SET_PAGE_DATA"; page: keyof GlobalState; payload: any }
  | { type: "RESET_ALL" }
  | { type: "RESET_PAGE"; page: keyof GlobalState };
...
export const AIDataProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <AIDataContext.Provider value={{ state, dispatch, chunkConstraints }}>
      {children}
