...
const coverPageData_00 = {
  r_0_1: "제품 리뷰 기반 감정 분석 보고서",
  r_0_2: "자사 vs 경쟁사 비교 분석",
  r_0_3: "https://via.placeholder.com/160x80.png?text=LOGO",
  r_0_4: "2025-06-13",
};

const contentsPageData_01 = {
  r_1_1: [
    "개요",
    "분석 대상 및 방법론",
    "자사 제품 리뷰 감정 분석 결과",
...
const expectationGapPageData_08 = {
  r_8_2: [
...
const solutionPageData_09 = {
  ...
  r_9_5_3: [
    {
      solution: "단기: 배터리 사용량 최적화 알고리즘 적용 (15% 효율 향상 목표)",
    },
...
const executionPlanPageData_10 = {
  r_10_1: [
    {
      solution: "배터리 최적화",
      ownerDept: "제품개발팀",
...
const executiveSummaryPageData_13 = {
...
export default function PromptTestPage2() {
  ...
  return (
    <div className="flex h-screen">
      ...
      >
        <A4Layout>
          <ReportCoverPage {...coverPageData_00} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ContentsPage_01 {...contentsPageData_01} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <OverviewPage_02 {...overviewPageData_02} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <SwotPage_03 {...swotPageData_03} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <SelfProductPage_04 {...selfProductPageData_04} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <CompetitorPage_05 {...competitorPageData_05} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ComparisonPage_06 {...comparisonPageData_06} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ImprovementPage_07 {...improvementPageData_07} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ExpectationGapPage_08 {...expectationGapPageData_08} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <SolutionPage_09 {...solutionPageData_09} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ExecutionPlanPage_10 {...executionPlanPageData_10} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ExecutionKPIPage_11 {...executionKPIPageData_11} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ConclusionPage_12 {...conclusionPageData_12} />
        </A4Layout>
        <PageSeparator />

        <A4Layout>
          <ExecutiveSummaryPage_13 {...executiveSummaryPageData_13} />
        </A4Layout>
        <PageSeparator />
